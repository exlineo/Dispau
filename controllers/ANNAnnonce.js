...
function Annonce()
{
	...
	this.personnesMax_nb = 0; /*nombre de personnes maximum*/
	this.personnesMin_nb = 0; /*nombre de personnes minimum*/
	...
	this.lieu_lie;  /*Id clé) du Lieu auquel est attaché l'annonce. */
